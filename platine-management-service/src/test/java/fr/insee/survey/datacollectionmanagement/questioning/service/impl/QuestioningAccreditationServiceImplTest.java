...
import fr.insee.survey.datacollectionmanagement.questioning.exception.NotFoundException;
...
class QuestioningAccreditationServiceImplTest {
    ...
    void testLogContactUpdate() {
        ...
        ContactEvent contactEvent = contactEventServiceStub.findContactEventsByContact(contact).stream().findFirst().get();
//        assertThat(contactEvent.get
        assertThat(contactSourceServiceStub.findContactSource()).hasSize(1);
    }
    ...
    private Questioning buildQuestioning(String suId, Long questioningId) {
        ...
        questioning.setIdPartitioning("partition-id");
