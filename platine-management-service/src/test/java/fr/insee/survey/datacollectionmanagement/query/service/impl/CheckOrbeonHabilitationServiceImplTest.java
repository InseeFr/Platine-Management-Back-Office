...
class CheckOrbeonHabilitationServiceImplTest {
    private CheckOrbeonHabilitationServiceImpl checkOrbeonHabilitationService;
    ...
    void init() {
        ...
        checkOrbeonHabilitationService = new CheckOrbeonHabilitationServiceImpl(
                viewServiceStub,
                userServiceStub);
    }
    ...
    void should_return_true_if_user_is_admin_v1() {
        ...
        //when
        boolean result = checkOrbeonHabilitationService.checkHabilitation(null,
                "id-su",
                "campaign-id",
                userRoles,
                "user-id");
    ...
    void should_return_false_if_habilitation_role_is_not_reviewer_v1() {
        ...
        //when
        boolean result = checkOrbeonHabilitationService.checkHabilitation(
    ...
    void should_return_false_if_role_undefined_and_user_is_not_respondant_v1(String habilitationRole) {
        ...
        //when
        boolean result = checkOrbeonHabilitationService.checkHabilitation(habilitationRole,
                "id-su",
                "campaign-id",
                userRoles,
                "user-id");
    ...
    void should_return_false_if_role_undefined_and_user_is_respondent_and_count_view_equals_to_zero_v1(String habilitationRole) {
        //given
        List<String> userRoles = List.of("plop", "test", AuthorityRoleEnum.RESPONDENT.securityRole());
