...
ALTER TABLE public.campaign ADD COLUMN datacollection_target varchar(255) NULL;
ALTER TABLE public.campaign ADD COLUMN sensitivity bool DEFAULT false NULL;
