...
class LdapServiceImplTest {
    ...
    public RestTemplate createTestRestTemplate() {
        WireMockRuntimeInfo wmRuntimeInfo = wm.getRuntimeInfo();
        RestTemplate restTemplate = new RestTemplateBuilder().rootUri(wmRuntimeInfo.getHttpBaseUrl()).build();
        restTemplate.getInterceptors()
                .add(new BasicAuthenticationInterceptor(LOGIN, PASSWORD));
    ...
    void initServiceWithStubs() {
        ldapRepository = new LdapRepositoryImpl(createTestRestTemplate());
