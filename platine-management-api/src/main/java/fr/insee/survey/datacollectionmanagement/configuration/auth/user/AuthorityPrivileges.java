...
public class AuthorityPrivileges {
    ...
    public static final String HAS_MANAGEMENT_PRIVILEGES = "hasAnyRole('INTERNAL_USER', 'WEB_CLIENT', 'ADMIN', 'SUPPORT')";
    public static final String HAS_ADMIN_PRIVILEGES = "hasRole('ADMIN')";
    ...
    public static final String HAS_PORTAL_PRIVILEGES = "hasAnyRole('PORTAL', 'INTERNAL_USER', 'WEB_CLIENT', 'ADMIN', 'SUPPORT')";
