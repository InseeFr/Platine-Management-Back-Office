...
public class ProfiledAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    // TODO: Here we can cache profile to avoid getting sources for user each time, can be based on principal claim name
    @Override
    public AbstractAuthenticationToken convert(Jwt jwt) {
        ...
        AuthorizationProfile profile = profileFactory.buildProfile(applicationRoles);
